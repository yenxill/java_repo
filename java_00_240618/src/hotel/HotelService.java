...
public class HotelService {
	...
	public void checkIn() {
		...
		if (roomNum < 1 || roomNum > hotelDAO.RoomCnt) {
			...
			System.out.println("객실 체크인이 완료 되었습니다. 즐거운 하루 보내세요.");
	...
	public void roomInfo() {
		...
		//roomList에서 Room 객체의 사용여부를 확인 할 수 있도록 반복문 구현
		//Room 객체의 사용 여부는 isUsing 으로 알 수 있다
		//isUsing = true  이면, 사용중
		...
		for(Room r : rooms) {
			if(r.isUsing() == true) {
				...
				System.out.println(cnt + "호 객실은 현재 비어있습니다.");
			}
	...
	public void checkOut() {
		System.out.println("몇 번 객실에서 체크아웃 하시겠습니까?");
		int roomNum = sc.nextInt();
		hotelDAO.checkOut(roomNum);
		
		System.out.println("안녕히 가십시오. 감사합니다.");
